...
function renderHeader(_ref, instance) {
  ...
  likeButton.innerHTML = '\n    ' + _icons.heart + '\n    ' + (likedReaction ? 'Unlike' : 'Like') + '\n    ' + (meta.reactions && meta.reactions.heart ? ' \u2022 <strong>' + meta.reactions.heart + '</strong> like' : '') + '\n  ';
  ...
  issueLink.innerText = 'Github Issue';
